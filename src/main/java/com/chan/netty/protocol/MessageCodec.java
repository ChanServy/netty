 ...
 * ByteToMessageCodec<Message> 效果是 ByteBuf 和 Message 之间进行转换，但是不可共享
 * <p>
 * 自定义协议要素:
...
public class MessageCodec extends ByteToMessageCodec<Message> {
    /**
     * 编码，出站前将自定义的Message编码成ByteBuf字节
     *
     * @param ctx ChannelHandlerContext
     * @param msg 入站的Message
     * @param out 将Message编码成ByteBuf字节，写入out
     * @throws Exception 异常
     */
    @Override
    ...
    /**
     * 解码，入站的时候将ByteBuf解码成Message消息
     *
     * @param ctx ChannelHandlerContext
     * @param in  入站的ByteBuf
     * @param out 将入站的ByteBuf解码成Message对象并将message存入out
     * @throws Exception 异常
     */
    @Override
